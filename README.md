...
Jupyter is available through two web portals. If you have an account on [Adroit](https://forms.rc.princeton.edu/registration/?q=adroit) or Della then browse to [https://myadroit.princeton.edu](https://myadroit.princeton.edu) or [https://mydella.princeton.edu](https://mydella.princeton.edu). To begin a session, click on "Interactive Apps" and then "Jupyter".
