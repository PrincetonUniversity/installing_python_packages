...
Jupyter is available through two web portals. If you have an account on [Adroit](https://forms.rc.princeton.edu/registration/?q=adroit) or Della then browse to [https://myadroit.princeton.edu](https://myadroit.princeton.edu) or [https://mydella.princeton.edu](https://mydella.princeton.edu). If you need an account on Adroit then complete [this form](https://forms.rc.princeton.edu/registration/?q=adroit).
